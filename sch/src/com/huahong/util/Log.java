...
import com.huahong.erp.ParamResources;
import com.huahong.util.Log;
//import com.huahong.erp.popedomManage.dao.LogDAO;
import com.huahong.erp.util.SysMaint;
import com.huahong.util.CommonException;

public class Log {
	
	private static String logfile = "log4j"; // 配置文件的目录
	...
	public static void logToDB(Object msg, String log_level) {
		if (SysMaint.getProperty("LOG_DB").equals("true")
				&& msg.getClass().getName().equals("java.lang.String")) { // 是否记录数据库日志
...
//				try {
//					dao.insertLog(user_name, log_level, ip, url, content,oper_module, oper_type);
