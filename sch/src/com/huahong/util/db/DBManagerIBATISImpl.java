...
public class DBManagerIBATISImpl implements IDBManager {
	...
	/* （非 Javadoc）
	 * @see com.neusoft.util.db.IDBManager#freeConnection(java.sql.ResultSet, java.sql.PreparedStatement, java.sql.Connection)
	 */
	...
	/* （非 Javadoc）
	 * @see com.neusoft.util.db.IDBManager#getConnection()
	 */
	...
	/* （非 Javadoc）
	 * @see com.neusoft.util.db.IDBManager#getMapClient()
	 */
