package com.huahong.util.security;
...
import com.huahong.util.security.SecurityImpl;

public abstract class Security{
	
	private static Security instance = null;
	private static Properties prop = null;
	private static final String defaultClass = "com.huahong.util.security.SecurityImpl";
	...
	public static final Security getInstance() {
		if (prop == null) {
			prop = ResourceReader.getResourcesFromPackage(
					"/com/huahong/util/security/config.properties",
					Security.class);
		}
		if (instance == null) {
