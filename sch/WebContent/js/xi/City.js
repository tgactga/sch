...
function changs(v){
                   var str="0";
				   for(i=0;i<v;i++){
					   str+=("_"+(document.getElementById(z[i]).selectedIndex-1));
									};
				   var zz=document.getElementById(z[v]);
				   with(zz){
					   length=0;
					   options[0]=new Option(opt0[v],opt0[v]);
					   if(v&&document.getElementById(z[v-1]).selectedIndex>0||!v){
						   if(dsy.Exists(str)){
							   ar=dsy.Items[str];
							 for(i=0;i<ar.length;i++){
							 options[length]=new Option(ar[i],ar[i]);
...
dsy.add("0_0_6",["合肥市区","长丰县","肥东县","肥西县"]);
...
var z=["xxshengfen","xxshiqu","xxxian"];
var opt0=["省份","地级市","县级市/县"];  
function setup(){ 
for(i=0;i<z.length-1;i++){ 
document.getElementById(z[i]).onchange=new Function("changs("+(i+1)+")");  
} 
changs(0);
} 
...
{ 
	...
	if (document.myform.CheckCode.value.length!=4) { 
	alert("验证码错误."); 
	document.myform.CheckCode.focus(); 
	return false; 
	}
	...
	if(!reg.test(myform.truename.value)){ 
	alert("请确定学生姓名为中文.");
	document.myform.truename.focus(); 
	return false; 
	} 
	...
	if (document.myform.xxshengfen.value==""||document.myform.xxshengfen.value=="省份") { 
	alert("请选择学校所在省"); 
	document.myform.xxshengfen.focus(); 
	return false; 
	}
	if (document.myform.xxshiqu.value==""||document.myform.xxshiqu.value=="地级市") { 
	alert("请选择学校所在市"); 
	document.myform.xxshiqu.focus(); 
	return false; 
	} 
	if (document.myform.xxxian.value==""||document.myform.xxxian.value=="县级市/县") { 
	alert("请选择学校所在县级市/县"); 
	document.myform.xxxian.focus(); 
	return false; 
	}
         
	if (document.myform.schname.value=="") { 
	alert("请输入你目前的学校名称"); 
	document.myform.schname.focus(); 
	return false; 
	}
        if (document.myform.nianji.value=="") { 
	alert("请选择你所在的所在年级"); 
	document.myform.nianji.focus(); 
	return false; 
	}

        var radios = document.getElementsByName("nianji");			
        var flag = false;			
	...
	if (document.myform.njpm.value=="") { 
	alert("请输入年级排名"); 
	document.myform.njpm.focus(); 
	return false; 
	}
	if (document.myform.njpm.value=="") { 
	alert("请输入年级排名"); 
	...
	if (document.myform.njrs.value=="") { 
	alert("请输入年级人数"); 
	document.myform.njrs.focus(); 
	return false; 
	}
	if (document.myform.tel1.value==""&&document.myform.tel2.value=="") { 
	alert("请输入一个有效的电话号码"); 
...
var onecount;
subcat = new Array();
subcat[0] = new Array("初一","初中","初一");
subcat[1] = new Array("初二","初中","初二");
subcat[2] = new Array("初三","初中","初三");
subcat[3] = new Array("高一","高中","高一");
subcat[4] = new Array("高二","高中","高二");
subcat[5] = new Array("高三","高中","高三");
subcat[6] = new Array("一年级","小学","一年级");
subcat[7] = new Array("二年级","小学","二年级");
subcat[8] = new Array("三年级","小学","三年级");
subcat[9] = new Array("四年级","小学","四年级");
subcat[10] = new Array("五年级","小学","五年级");
subcat[11] = new Array("六年级","小学","六年级");
onecount=11;
function changelocation(locationid)
    {
    document.myform.banji.length = 1; 
    ...
    for (i=0;i < onecount; i++)
        {
            ...
            { 
                document.myform.banji.options[document.myform.banji.length] = new Option(subcat[i][0], subcat[i][2]);
            }        
        }
    }    