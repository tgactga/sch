...
{ 
	...
	function addCookie(){　 // 加入收藏
		if (document.all) {
		　　window.external.addFavorite('http://www.sj99.com.cn', '九九网络工作室');
		}else if (window.sidebar) {
		　	 window.sidebar.addPanel('九九网络工作室','http://www.sj99.com.cn', "");
		}
	}　　　　　　
	...
	　　　document.body.setHomePage('http://www.sj99.com.cn');　　　　　　　　　　
	　 }else if (window.sidebar) {
			if (window.netscape) {
		　　　  try {
		...
		　 prefs.setCharPref('browser.startup.homepage','http://www.sj99.com.cn');
	　 }
	} 
